...
<section class="smartphone-hero-section">
    <div class="smartphone-hero-background">
        <div class="smartphone-hero-content">
            <div class="smartphone-hero-text">
                <h1>Your Perfect Smartphone Awaits</h1>
                <p>Experience cutting-edge technology and sleek design. Discover the features that will elevate your mobile experience.</p>
                <button class="smartphone-hero-button">Shop Now</button>
            </div>
            <img src="include/pic/shop/smartphone/2.png" alt="Smartphone" class="smartphone-hero-img">
        </div>
    </div>
</section>
