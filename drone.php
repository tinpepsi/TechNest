 ...
 * Date: 11/9/2024
 * Purpose: This page display drone and camera product
-->
...
<!-- Start top-drone-camera Area -->
<section class="top-drone-camera-area section-gap">
    <div class="container custom_drone_container">
        <div class="row d-flex justify-content-center">
            <div class="menu-content pb-60 col-lg-10">
                <div class="title text-center">
                    <h1 class="mb-10">Top Drones and Cameras Available Now</h1>
                    <p>Explore our range of drones and cameras designed for high-quality imaging and effortless flight.</p>
                </div>
            </div>
        </div>                    
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-3 feature-left"> <!-- LEFT SIDE -->
                <div class="single-feature mb-4"> <!-- TOP -->
                    ...
                    <p>
                        Capture stunning photos and videos with our advanced camera systems, delivering exceptional clarity.
                    </p>
                </div>
                <div class="single-feature"> <!-- BOTTOM -->
                    <span class="lnr lnr-gift"></span>
                    <h4>Versatile Shooting Modes</h4>
                    <p>
                        Enjoy multiple shooting options, including aerial, panoramic, and time-lapse modes for creative photography.
                    </p>
                </div>                            
            </div>
            <div class="col-lg-6 feature-middle"> <!-- CENTER -->
                <img class="img-fluid mx-auto d-block" src="include/pic/shop/drone/1.png" alt="Drone and Camera Image">
            </div>
            <div class="col-lg-3 feature-right"> <!-- RIGHT SIDE -->
                <div class="single-feature mb-4"> <!-- TOP -->
                    ...
                    <p>
                        Experience longer flight durations with high-capacity batteries, allowing you to capture more without interruptions.
                    </p>
                </div>
                <div class="single-feature"> <!-- BOTTOM -->
                    <span class="lnr lnr-sun"></span>
                    <h4>Lightweight & Portable Design</h4>
                    <p>
                        Designed for easy transport, our drones are lightweight, making it simple to take your photography anywhere.
                    </p>
                </div>                                                         
            </div>
        </div>
...
<section class="product-card-section py-5">
    <div class="container">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card">
                <img src="include/pic/shop/drone/6.png" class="card-img-top" alt="Camera Model C">
                <div class="card-body">
                    <h5 class="card-title">Camera Model C Ultra</h5>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card">
                <img src="include/pic/shop/drone/1.png" class="card-img-top" alt="Drone Model X">
                <div class="card-body">
                    <h5 class="card-title">Drone Model X Pro</h5>
                    <div class="product-rating">
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card">
                <img src="include/pic/shop/drone/4.png" class="card-img-top" alt="Camera Model Z">
                <div class="card-body">
                    <h5 class="card-title">Camera Model Z Pro</h5>
                    <div class="product-rating">
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card">
                <img src="include/pic/shop/drone/3.png" class="card-img-top" alt="Drone Model Y">
                <div class="card-body">
                    <h5 class="card-title">Drone Model Y Lite</h5>
                    <div class="product-rating">
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
                        <i class="fa-solid fa-star filled"></i>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="single-box-item first-box">
                                <img src="include/pic/shop/drone/9.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-box-item second-box">
                                <img src="include/pic/shop/drone/8.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-box-item large-box">
                        <img src="include/pic/shop/drone/10.png" alt="">
                    </div>
                </div>
            </div>
        </div>
